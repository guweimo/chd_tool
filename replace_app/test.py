from PyQt5.QtWidgets import QApplication, QComboBox, QListView, QStylePainter, QStyle, QStyleOptionComboBox
...
class CheckableComboBox(QComboBox):
    ...
    def paintEvent(self, event):
        ...
        if selected:
            opt.text = ", ".join(selected)
            opt.currentText = opt.text  # 确保当前文本也更新
        else:
            opt.text = "请选择..."
            opt.currentText = opt.text  # 确保当前文本也更新
